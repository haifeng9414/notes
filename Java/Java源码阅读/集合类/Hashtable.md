...
public class Hashtable<K,V>
     ...
     */
    // 判断是否存在某个key的value为指定的value
    // 和直观上不一样，这个方法侧重的是value而不是key
    ...
    public synchronized boolean containsKey(Object key) {
        ...
        // Hashtable求index方法简单粗暴，直接用hash值求余
    ...
    protected void rehash() {
        ...
        // 遍历原来的数组，所有的数组元素的链表中所有结点都重新计算一次index
    ...
    public synchronized V put(K key, V value) {
        ...
        // 如果index所在数组的链表已经存在则先判断key是否已经存在
